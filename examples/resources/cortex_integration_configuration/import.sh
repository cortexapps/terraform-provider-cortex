...
# cannot change in place (for example the GitLab host, the Jira host, or a Datadog custom subdomain) to the values in
# Cortex, or the next apply replaces the configuration.
